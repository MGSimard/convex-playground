...
function DrawerPortal({ ...props }: React.ComponentProps<typeof BaseDrawer.Portal>) {
...
function DrawerOverlay({ className, ...props }: React.ComponentProps<typeof BaseDrawer.Overlay>) {
  return (
    <BaseDrawer.Overlay
      className={cn(
...
function DrawerContent({ className, children, ...props }: React.ComponentProps<typeof BaseDrawer.Content>) {
  return (
    <DrawerPortal>
      <DrawerOverlay />
      <BaseDrawer.Content
...
function DrawerTitle({ className, ...props }: React.ComponentProps<typeof BaseDrawer.Title>) {
  return <BaseDrawer.Title className={cn("text-foreground font-semibold", className)} {...props} />;
}

function DrawerDescription({ className, ...props }: React.ComponentProps<typeof BaseDrawer.Description>) {
  return <BaseDrawer.Description className={cn("text-muted-foreground text-sm", className)} {...props} />;
}
