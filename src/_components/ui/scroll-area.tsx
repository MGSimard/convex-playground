...
function ScrollArea({
  ...
  return (
    <BaseScrollArea.Root className={cn("relative", className)} {...props}>
      <BaseScrollArea.Viewport className="focus-visible:ring-ring/50 size-full overscroll-contain rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline">
        {children}
