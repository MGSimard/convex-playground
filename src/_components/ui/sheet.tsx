...
function SheetTitle({ className, ...props }: React.ComponentProps<typeof BaseSheet.Title>) {
  return <BaseSheet.Title className={cn("text-foreground font-semibold", className)} {...props} />;
}

function SheetDescription({ className, ...props }: React.ComponentProps<typeof BaseSheet.Description>) {
  return <BaseSheet.Description className={cn("text-muted-foreground text-sm", className)} {...props} />;
}
